...
public class CurveHeadLoadingView extends View {
     ...
     * BASELINE的高度
     */
    private final int PAINT_TEXT_BASEIINE = PAINT_TEXTSIZE;
    /**
     * 画出来的文字
     */
     ...
     * 最大的画弧形的时候的间距
     */
    private final int MAX_RECF_SPACE = 36;
    /**
     * 最小的画弧形的时候的间距
     */
     ...
     * 来回弹动的时间
     */
    private final int MAX_SPRING_COUNT = 18;
    /**
     * 当前弹动的次数
     */
